...
Modular Architecture Stateless Turn-based Implementation of Chess
...
>>> play_mast_chess(user_gamename_input, user_move_from_to_input

etc. e.g.
>>> mast_chess.folder_system_check_setup("{gamename}")
>>> mast_chess.play_mast_chess("{gamename}", "d2d3")
...
def check_non_move_commands( move_from_to_input, gamename, is_a_move_flag, print_report_flag, comment ):
    ...
    return (is_a_move_flag, print_report_flag, comment)
...
def print_board(first_move,
    ...
    if check_checkmate_flag:
        ...
        print("inspection inspection,", move_from_to_input)
...
def import_read_create_game_log_to_list(gamename):
    ...
    try:
        ...
        print("import_read_create_game_log_to_list reads ->", file_string)
...
def make_html_report(whose_move_is_it,
    ...
    <html>
        ...
        <p style="font-size:20px; "> Ramen <a href="https://y0urm0ve.com/white_dragon_ramen" style="color: #8ebf42">y0urm0ve.com/white_dragon_ramen</a> </p>
...
############
############
def play_mast_chess(user_gamename_input, user_move_from_to_input):
    global board
    ...
    # refresh list
    gamelog_movelist = import_read_create_game_log_to_list(gamename)
    print("final wrap-up: ", str(gamelog_movelist))
