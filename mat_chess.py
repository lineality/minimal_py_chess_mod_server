...
def check_is_capture_boolean(board, move_from_to_input, first_move):
...
def play_mat_chess(user_gamename_input, user_move_from_to_input):
    ...
    gamename = user_gamename_input
    move_from_to_input = user_move_from_to_input
    ...
    # Will be Capture?
    ###################
    was_capture = check_is_capture_boolean( board, 
                                            move_from_to_input, 
                                            first_move)
